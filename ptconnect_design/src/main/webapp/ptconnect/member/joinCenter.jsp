...
<link href="${pageContext.request.contextPath}/source/css/join.css" type="text/css" rel="stylesheet">
						...
						<div class="joinWrap">
							...
							<div class="joinBox">
								...
								<div class="centerName">
									<h3>센터 이름(상호명)</h3>
									<input type="text" id="centerName" placeholder="사업자 등록된 내용과 다를 경우 가입이 거부됩니다">
								</div>
								
								<div class="BusinessNum">
									<h3>사업자 번호</h3>
									<input type="text" id="BusinessNum" placeholder="가입심사에 활용됩니다 정확하게 입력해주세요">
								</div>
								
								<div class="userAddr">
									<h3>주소</h3>
									<div class="flexBox">
										<input type="text" id="certified" placeholder="우편번호">

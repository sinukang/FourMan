...
<meta charset="UTF-8">
<title>트레이너 찾기</title>
<link href="./coach.css" type="text/css" rel="stylesheet">
		...
		<div class="searchTab_wrap">
			<div class="searchBar_wrap">
				<div class="searchType">
					...
					<div class="filter">
						<img src="./filter_icon_black.svg" alt="Filter Icon" width="24px" height="24px">
					</div>
				...
				<form id="filter_Form" action="${pageContext.request.contextPath}/findTrainer.do" method="get">
					...
					<div class="searchBar_option">
						<div class="flex">
							<div>
								<img src="./markericon.png" width="17px" height="25px">
								<span>
									<span id="address-1" class="search_key">금암동</span> 검색 결과
					...
					<div class="filter_option <c:if test='${filterOnOff eq 1}'>visible</c:if>">
						<div class="filter_Initialization">
							<div class="headerComp">
								<img src="./arrow_left.svg" alt="search">
							</div>
							<div class="headerComp">
									...
									<div class="coachInfo">
										<div class="coachTitle">
											...
											<div class="coachReviewCnt">
												<img class="reviewIcon" src="./staricon.png">

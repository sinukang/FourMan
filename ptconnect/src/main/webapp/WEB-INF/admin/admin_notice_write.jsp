        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">공지사항 작성</h1>
                            ...
                            <div class="card shadow mb-4">
	                            <form id="form" class="form" name="frm">
									...
									<div class="notice-write-cont">
										<textarea class="input-point" placeholder="내용을 입력하세요."></textarea>
									</div>
								</form>	
								<div class="notice-write-btn-area">
									<button class="notice-write-btn">글쓰기</button>
									<button class="notice-delete-btn" onclick="location.href='./admin_notice.jsp'">취소</button>
								</div>
                            </div>

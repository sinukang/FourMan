    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePage3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html">포인트 내역</a>
                        <a class="collapse-item" href="register.html">포인트 관리</a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePage5"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>고객지원</span>
                </a>
                <div id="collapsePage5" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Login Screens:</h6> -->
                        <a class="collapse-item active" href="./admin_notice.jsp">공지사항</a>
                            ...
                            <div class="card shadow mb-4">
								<div class="notice-area">
									<header class="notice-head">
										<h2><span class="notice-title">공지사항 제목</span></h2>
								...
								<div class="notice-write-btn-area detail">
									<button class="notice-modify-btn" onclick="location.href='./admin_notice_modify.jsp'">수정</button>
									<button class="notice-delete-btn" onclick="location.href='./admin_notice.jsp'">뒤로가기</button>
								</div>
                            </div>

...
<body id="page-top">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                            	<table class="table tb1">
                            		...
                            		<c:forEach var="i" begin="1" end="10" step="1">
                            			<tr class = "review-list" data-target="review-cont-${i}">
	                            			...
	                            			<td class="notice-num">${i}</td>
	                            			<td class="notice-writer">관리자</td>
	                            			<td class="notice-subject" onclick="location.href='./admin_notice_detail.jsp'">제목${i}</td>
	                            			<td class="notice-date">작성일${i}</td>
                            	...
                            	<div class="notice-wirte-area">
                            		<button class="notice-write-btn" onclick="location.href='./admin_notice_write.jsp'">글쓰기</button>
                            	</div>
                            	<div class="row mt-4">
                            		<div class="col-lg-12">
	...
	$(document).ready(function() {
		...
		$(".notice-modify-btn").on("click", function() { 
			location.href = "./admin_notice_modify.jsp";
		});

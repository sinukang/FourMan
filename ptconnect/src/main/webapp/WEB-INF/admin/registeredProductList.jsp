...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/normal_css/registeredProductList.css" rel="stylesheet">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities1" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="./registeredProductList.jsp">등록 상품 리스트</a>
